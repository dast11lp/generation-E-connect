const integrantes = [
  {
    ...
    github: "https://github.com/daniel-lopez",
  },
  {
    nombre: "María",
    ...
    github: "https://github.com/mary-smith",
  },
  {
    nombre: "Miguel",
    ...
    github: "https://github.com/persona-3",
  },
  {
    nombre: "Henry",
    cargo: "QA Tester",
  ...
  },
  {
    ...
    github: "https://github.com/persona-5",
  },
];
  ...
  return `
    <div class="tarjeta">
      ...
      <div class="tarjeta__texto">
        ...
        <div class="redes">
          <a class="redes__icono" href="${persona.linkedin}" target="_blank" rel="noopener noreferrer">
            ${iconoLinkedin}
          </a>
          <a class="redes__icono" href="${persona.github}" target="_blank" rel="noopener noreferrer">
            ${iconoGithub}
          </a>
        </div>
      </div>
